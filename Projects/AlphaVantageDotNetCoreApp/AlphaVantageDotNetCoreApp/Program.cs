/*
 *  AlphaVantage Nuget Package
 *      Install-Package Avapi -Version 1.4.8.3
 * AlphaVantage API Github
 *      https://github.com/AvapiDotNet/Avapi
 * 
 * Install The AVAPI.NET Core with Package Manager
 *  Install-Package Avapi
 * 
 * AlphaVantage API Key: 11T68YL4UZ067FQZ
 * 
 * Tutorial: https://github.com/AvapiDotNet/Avapi
 */
...
namespace Avapi
{
    public class Example
    {
        static void Main()
        {
            ...
            connection.Connect("11T68YL4UZ067FQZ");
